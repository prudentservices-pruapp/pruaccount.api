// <copyright file="BankStatementMapDetailFile.cs" company="PlaceholderCompany">
...
namespace Pruaccount.Api.Entities
{
    ...
    /// <summary>
    /// BankStatementMapDetailFile.
    /// </summary>
    public class BankStatementMapDetailFile
    {
        /// <summary>
        ...
        public bool IsNew
        {
            get
            {
                return this.BankStatementMapDetailFileId == default(int);
            }
        }
    }
}
