// <copyright file="SupplierBusinessPaymentDetails.cs" company="PlaceholderCompany">
...
namespace Pruaccount.Api.Entities
{
    ...
    /// </summary>
    public class SupplierBusinessPaymentDetails
    {
        /// <summary>
        /// Gets or sets SupplierBusinessPaymentDetailsId.
        /// </summary>
        public int SupplierBusinessPaymentDetailsId { get; set; }
